...
export default function Cards() {
  return (
    <div className="cards flex gap-5">
      <Card title="total reads" subTitle="0">
        <div className="rate flex items-center gap-2 text-green-500">
          <p className="value text-xs rounded-full p-2 bg-green-50">+ 0.00%</p>
          <span className="icon">
      ...
      <Card title="monthly view threshold" subTitle="0"></Card>
      <Card title="total blog post" subTitle="0">
