...
const Content = () => {
  return (
    <section className="space-y-10 mb-48">
      <div className="section-title flex items-center text-start gap-8 text-ui-dark font-bold">
        <p className="capitalize text-4xl">our story</p>
        <RxArrowBottomRight className="text-3xl" />
      </div>

      <div className="section-body flex gap-10 items-center justify-between h-max">
        <div className="h-[500px] w-[401px] rounded-[20px] overflow-hidden">
          <Image src={imgBuilding} alt="building" width={400} height={560} className="size-full object-center object-cover" />
        </div>

        <div className="space-y-[65px] text-start h-full w-[700px] text-ui-desc">
