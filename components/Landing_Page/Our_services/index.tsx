    ...
    <section className="container max-w-screen-xl mx-auto w-full mt-20">
      ...
      style={{
        ...
        <div className="rounded-[32px] p-3 bg-[#0B2831] flex flex-col gap-2 col-span-2 row-span-2 h-full">
          <div className="h-3/6 ">
            <Image placeholder="blur"  blurDataURL={dataUrl} src={imgs} alt="services image"  className="rounded-[32px] w-full object-cover h-full"/> 
          </div>
        ...
        <div className="rounded-[32px] p-3 bg-[#0B2831] flex flex-col gap-4 col-span-2">
          <div className=" relative h-3/6">
            <Image placeholder="blur"  blurDataURL={dataUrl} src={imgs} alt="services image" className="rounded-[32px] object-cover w-full h-full"/> 
          </div>
        ...
        <div className="rounded-[32px] p-3 bg-[#0B2831] flex flex-col gap-5 row-span-2 col-span-1">
          <div className="h-full">
            <Image placeholder="blur"  blurDataURL={dataUrl} src={imgs} alt="services image"  className="rounded-[32px] w-full h-full object-cover"/> 
          </div>
